...
4. Crie/Referêncie uma nova **branch** e nomeie como `feat/community/schnanet`: `git checkout -b feat/community/schnanet`;
...
4. Create/Reference a new **branch** and name it `feat/community/schnanet`: `git checkout -b feat/community/schnanet`;
